    ...
    {/* Titre */}
      ...
      <div className="flex items-center space-x-3 mb-4 ">
        ...
        <div className="space-y-4 mb-6 ">
          <button className={`w-full h-12 flex items-center justify-start rounded-lg font-bold 
            ${isDarkMode ? 'hover:bg-gray-600 text-white' : 'hover:bg-gray-200 text-gray-700'}`}>
      ...
      {/* Groupe par defaut */}
      <div className="mt-6">
              <h3 className="font-bold text-lg mb-2">Votre groupe par défaut</h3>
