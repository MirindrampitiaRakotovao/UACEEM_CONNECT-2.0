...
import { Home, Users, Lightbulb, MessageCircle, Bell , Moon , SunDim} from 'lucide-react';
...
<nav className="flex justify-between items-center px-5 h-16 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700">
      ...
      <div className="flex justify-center flex-1">
        ...
        <li
              className={`relative flex flex-col items-center cursor-pointer ${currentPath === '/homeDelegue' ? 'border-b-2 border-[#1c3d6e] rounded-b-lg w-16' : 'w-15'}`}
              onClick={() => navigate('/homeDelegue')}
          >
            <Home size={25} className={`${currentPath === '/homeDelegue' ? 'text-[#1c3d6e]' : 'dark:text-white'}`} />
          </li>
          <li 
